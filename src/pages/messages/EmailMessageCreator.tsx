...
export const EmailMessageCreator = ({message, handleChange}: Props):JSX.Element => {
    return  (
        <>
            <div className="space-y-3">
                ...
                <textarea
                    ...
                    required
                />
                <p className="text-sm text-gray-500 text-right">{message.length}/1000 {t("common.characters")}</p>
            </div>
        </>
    )
}